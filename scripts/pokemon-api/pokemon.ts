...
const getApiId = (jsonId: string) => {
	...
	case "minior-core-form": return "minior-red"
	...
	case "frillish": return "frillish-male"
	case "jellicent": return "jellicent-male"
	...
	case "ogerpon-heartflame-mask": return "ogerpon-hearthflame-mask"
	case "terapagos-terastal-form": return "terapagos-terastal"
	case "terapagos-stellar-form": return "terapagos-stellar"
	}
...
export async function getOnePokemon(id: string): Promise<Pokemon | undefined> {
	superconsole.debug(`Fetching pokemon from cache: ${id}`)
