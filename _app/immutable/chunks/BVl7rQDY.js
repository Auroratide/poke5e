import{s as x}from"./BtxCbb_A.js";import{S as w,i as g,s as d,d as k,t as b,a as E,m as B,c as L,b as I,u as Q,f as c,g as p,l as e,v as h,o as _,w as y,x as f,y as v}from"./DdXth8Ou.js";import"./BxlXVsHr.js";import{I as S}from"./DAoiKo8V.js";function $(u,a){return async(...n)=>{try{await a(...n)}catch{}}}const j=$("create_pageview_event",async u=>{await x.rpc("create_pageview_event",{_path:u})}),z=$("create_pageview_event",async u=>{await x.rpc("create_pageview_event",{_path:`/backups/${u}`})});function q(u){let a,n,t,o,s,m,i;return{c(){a=f("path"),n=v(),t=f("rect"),o=v(),s=f("rect"),m=v(),i=f("line"),this.h()},l(r){a=h(r,"path",{class:!0,d:!0}),_(a).forEach(c),n=y(r),t=h(r,"rect",{class:!0,width:!0,height:!0,x:!0,y:!0,rx:!0,ry:!0}),_(t).forEach(c),o=y(r),s=h(r,"rect",{class:!0,width:!0,height:!0,x:!0,y:!0,rx:!0,ry:!0}),_(s).forEach(c),m=y(r),i=h(r,"line",{class:!0,x1:!0,y1:!0,x2:!0,y2:!0}),_(i).forEach(c),this.h()},h(){e(a,"class","stroke main-body"),e(a,"d",`
		M 20 15
		L 70 15
		L 85 30
		L 85 80
