var e=`change`,t=`commit`,n=(t,n,r)=>new CustomEvent(e,{detail:{item:t,oldIndex:n,newIndex:r}}),r=(e,n,r)=>new CustomEvent(t,{detail:{item:e,oldIndex:n,newIndex:r}}),i=class e extends HTMLElement{static defaultElementName=`reorder-item`;static html=`
	...
	`;constructor(){super(),this.#r()}list=()=>this.closest(f.defaultElementName);item=()=>this.closest(i.defaultElementName);#e=void 0;connectedCallback(){this.#e??=this.hasAttribute(`aria-label`)||this.hasAttribute(`aria-labelledby`),this.hasAttribute(`role`)||this.setAttribute(`role`,`button`),this.hasAttribute(`tabindex`)||this.setAttribute(`tabindex`,`0`),this.refreshLabel(),this.addEventListener(`pointerdown`,this.#t),this.addEventListener(`keydown`,this.#n)}refreshLabel=()=>{if(this.#e)return;let t=o(this.item()??this);t.length>0&&this.setAttribute(`aria-label`,e.labelFor(t))};#t=e=>{e.target instanceof HTMLElement&&e.target.dataset.ignoreReorder!=null||(e.preventDefault(),e.stopPropagation(),this.item()?.startDragging(this))};#n=e=>{e.key===` `&&e.preventDefault()};#r=()=>{let t=this.shadowRoot??this.attachShadow({mode:`open`}),n=document.createElement(`style`);n.innerHTML=e.css;let r=document.createElement(`template`);return r.innerHTML=e.html,t.appendChild(n),t.appendChild(r.content),t}},c=`data-reorder-list-announcer`,l=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`[${c}]`);if(e!=null)return e;let t=document.createElement(`div`);return t.setAttribute(c,``),t.setAttribute(`aria-live`,`polite`),t.setAttribute(`aria-atomic`,`true`),t.style.cssText=[`position: absolute`,`width: 1px`,`height: 1px`,`margin: -1px`,`padding: 0`,`border: 0`,`overflow: hidden`,`white-space: nowrap`,`clip-path: inset(50%)`].join(`;`),document.body.appendChild(t),t},u=e=>e.checkVisibility({visibilityProperty:!0,contentVisibilityAuto:!0}),d=()=>{let e=document.activeElement;for(;e?.shadowRoot?.activeElement!=null;)e=e.shadowRoot.activeElement;return e},f=class e extends HTMLElement{static defaultElementName=`reorder-list`;static COMMIT_DEBOUNCE_MS=1e3;static announcementFor=(e,t,n)=>`${e}, position ${t} of ${n}`;static html=`
		<slot></slot>
	`;static css=`
		:host {
			display: block;
	...
	`;constructor(){super(),this.#d()}get orientation(){return this.getAttribute(`orientation`)??`vertical`}set orientation(e){this.setAttribute(`orientation`,e)}items=()=>Array.from(this.querySelectorAll(`:scope > ${i.defaultElementName}`));visibleItems=()=>this.items().filter(u);nearestVisible=(e,t,n=this.items())=>{for(let r=e+t;r>=0&&r<n.length;r+=t)if(u(n[r]))return r;return-1};current=()=>{let e=d()?.closest(i.defaultElementName);return e?.parentElement===this?e:null};connectedCallback(){this.setAttribute(`role`,`list`),l(),this.addEventListener(`keydown`,this.#n),this.addEventListener(t,this.#r)}reorder=(e,t,r=this.items())=>{let i=r[e],a=d();this.#e(i,e<t?r[t].nextSibling:r[t]),this.dispatchEvent(n(i,e,t)),a instanceof HTMLElement&&d()!==a&&a.focus()};#e=(e,t)=>{if(typeof this.moveBefore==`function`)try{this.moveBefore(e,t);return}catch{}this.insertBefore(e,t)};#t=void 0;#n=t=>{let n=this.#u();if(!n.includes(t.key))return;let r=this.#a(t);if(r==null)return;let i=this.items(),a=i.indexOf(r);if(a<0)return;let o=this.nearestVisible(a,t.key===n[0]?-1:1,i);if(!(o<0)){if(t.preventDefault(),t.stopPropagation(),!t.altKey){i[o].handle()?.focus();return}window.clearTimeout(this.#t??-1),this.#c(r),this.reorder(a,o,i),this.#t=window.setTimeout(this.#l,e.COMMIT_DEBOUNCE_MS),this.#i(r,o,i.length)}};#r=e=>{let{item:t,oldIndex:n,newIndex:r}=e.detail;n!==r&&this.#i(t,r,this.items().length)};#i=(t,n,r)=>{let i=l(),a=e.announcementFor(o(t),n+1,r);i!=null&&i.textContent!==a&&(i.textContent=a)};#a=e=>{let t=e.composedPath(),n=t.findIndex(e=>e instanceof i);if(n<0)return null;let r=t[n];return t.slice(0,n).some(e=>e instanceof s||e===r.defaultHandle())&&r.list()===this?r:null};#o=void 0;#s=void 0;#c=e=>{this.#o!=null&&this.#o!==e&&this.#l(),this.#o??(this.#o=e,this.#s=this.items().indexOf(e))};#l=()=>{let e=this.#o;if(e==null)return;let t=this.items().indexOf(e);this.dispatchEvent(r(e,this.#s??-1,t)),this.#o=void 0,this.#s=void 0};#u=()=>this.orientation===`horizontal`?[`ArrowLeft`,`ArrowRight`]:[`ArrowUp`,`ArrowDown`];#d=()=>{let t=this.shadowRoot??this.attachShadow({mode:`open`}),n=document.createElement(`style`);n.innerHTML=e.css;let r=document.createElement(`template`);return r.innerHTML=e.html,t.appendChild(n),t.appendChild(r.content),t}};window.customElements.get(f.defaultElementName)||window.customElements.define(f.defaultElementName,f),window.customElements.get(i.defaultElementName)||window.customElements.define(i.defaultElementName,i),window.customElements.get(s.defaultElementName)||window.customElements.define(s.defaultElementName,s);