import{s as $}from"./DhiesKGl.js";import{s as w,n as g,d as c,i as p,f as e,l as h,h as _,m as y,o as f,p as v}from"./B174ZEAr.js";import{S as d,i as k,d as b,t as E,a as B,m as L,c as I,b as Q}from"./DIa7DxCc.js";import{I as S}from"./DHOrYH3Q.js";function x(u,a){return async(...n)=>{try{await a(...n)}catch{}}}const j=x("create_pageview_event",async u=>{await $.rpc("create_pageview_event",{_path:u})}),z=x("create_pageview_event",async u=>{await $.rpc("create_pageview_event",{_path:`/backups/${u}`})});function q(u){let a,n,t,o,s,m,i;return{c(){a=f("path"),n=v(),t=f("rect"),o=v(),s=f("rect"),m=v(),i=f("line"),this.h()},l(r){a=h(r,"path",{class:!0,d:!0}),_(a).forEach(c),n=y(r),t=h(r,"rect",{class:!0,width:!0,height:!0,x:!0,y:!0,rx:!0,ry:!0}),_(t).forEach(c),o=y(r),s=h(r,"rect",{class:!0,width:!0,height:!0,x:!0,y:!0,rx:!0,ry:!0}),_(s).forEach(c),m=y(r),i=h(r,"line",{class:!0,x1:!0,y1:!0,x2:!0,y2:!0}),_(i).forEach(c),this.h()},h(){e(a,"class","stroke main-body"),e(a,"d",`
		M 20 15
		L 70 15
		L 85 30
		L 85 80
