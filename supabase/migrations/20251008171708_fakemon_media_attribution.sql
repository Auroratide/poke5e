ALTER TABLE private.fakemon
	ADD COLUMN art_attribution_type VARCHAR(255),
	ADD COLUMN sprite_attribution_type VARCHAR(255),
	ADD COLUMN sprite_attribution_name VARCHAR(255),
	ADD COLUMN sprite_attribution_href VARCHAR(255);
