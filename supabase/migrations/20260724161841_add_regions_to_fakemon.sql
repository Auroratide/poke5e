ALTER TABLE private.fakemon
	ADD COLUMN native_region VARCHAR(255) DEFAULT NULL,
	ADD COLUMN regions VARCHAR(255)[] DEFAULT '{}';
...
CREATE OR REPLACE FUNCTION new_fakemon(
	...
	_biomes VARCHAR(255)[],
	_tags VARCHAR(255)[],
	_native_region VARCHAR(255),
	_regions VARCHAR(255)[],
	OUT ret_id UUID,
