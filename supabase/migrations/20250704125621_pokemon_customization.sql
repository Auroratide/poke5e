ALTER TABLE private.pokemon
	ADD COLUMN custom_size VARCHAR(255),
	ADD COLUMN hit_dice_size VARCHAR(4),
	ADD COLUMN speed_walking INT,
	ADD COLUMN speed_climbing INT,
	ADD COLUMN speed_swimming INT,
	ADD COLUMN speed_flying INT,
	ADD COLUMN speed_hover INT,
	ADD COLUMN speed_burrowing INT,
	ADD COLUMN sense_darkvision INT,
	ADD COLUMN sense_blindsight INT,
	ADD COLUMN sense_tremorsense INT,
	ADD COLUMN sense_truesight INT,
	ADD COLUMN bond_level INT NOT NULL DEFAULT 0,
	ADD COLUMN bond_points_cur INT NOT NULL DEFAULT 0,
	ADD COLUMN bond_points_max INT NOT NULL DEFAULT 0;
