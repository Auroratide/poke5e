ALTER TABLE private.trainers
	ADD COLUMN hit_dice_size VARCHAR(4),
	ADD COLUMN token_color VARCHAR(255),
	ADD COLUMN token_crop_x REAL DEFAULT 0.5, -- 0 to 1
	ADD COLUMN token_crop_y REAL DEFAULT 0.5, -- 0 to 1
	ADD COLUMN token_crop_size REAL DEFAULT 1.0; -- 0 to 1
...
RETURNS TABLE (
	...
	rank_persuasion INT,
	tags VARCHAR(255)[],
	hit_dice_size VARCHAR(4),
	token_color VARCHAR(255),
	token_crop_x REAL,
	token_crop_y REAL,
	token_crop_size REAL
) AS $$
BEGIN
	RETURN QUERY SELECT
		trainers.id,
		...
		trainers.tags,
		trainers.hit_dice_size,
		trainers.token_color,
		trainers.token_crop_x,
		trainers.token_crop_y,
		trainers.token_crop_size
...
CREATE OR REPLACE FUNCTION new_trainer(
	...
	_token_color VARCHAR(255),
	_token_crop_x REAL,
	_token_crop_y REAL,
	_token_crop_size REAL,
	OUT ret_id uuid,
...
BEGIN
	UPDATE private.trainers SET
		...
		token_color = _token_color,
		token_crop_x = _token_crop_x,
		token_crop_y = _token_crop_y,
		token_crop_size = _token_crop_size
	WHERE
