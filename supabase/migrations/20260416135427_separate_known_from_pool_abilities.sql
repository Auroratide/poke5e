ALTER TABLE private.abilities DROP CONSTRAINT must_have_pokemon_or_fakemon;
ALTER TABLE private.abilities DROP COLUMN fakemon_id;

ALTER TABLE private.fakemon
	ADD COLUMN ability_pool JSON DEFAULT '{"normal":[],"hidden":[]}';
...
DROP FUNCTION get_abilities(_fakemon_id UUID);


-- ABILITY POOLS ON FAKEMON
