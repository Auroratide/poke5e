CREATE TABLE private.fakemon (
	id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
	read_key VARCHAR(32) DEFAULT nanoid(13) NOT NULL,
   write_key VARCHAR(32) DEFAULT nanoid(16) NOT NULL,
	...
	egg_groups VARCHAR(255)[] NOT NULL,
	gender VARCHAR(255) NOT NULL,
	description TEXT NOT NULL,
	ac INT NOT NULL,
	hp INT NOT NULL,
	hit_dice VARCHAR(4) NOT NULL,
	speed_walking INT NOT NULL,
	speed_climbing INT NOT NULL,
	speed_swimming INT NOT NULL,
	speed_flying INT NOT NULL,
	speed_hover INT NOT NULL,
	speed_burrowing INT NOT NULL,
	sense_darkvision INT NOT NULL,
	sense_blindsight INT NOT NULL,
	sense_tremorsense INT NOT NULL,
	sense_truesight INT NOT NULL,
	...
	hidden_abilities VARCHAR(255)[] NOT NULL,
	moves_start VARCHAR(255)[] NOT NULL,
	moves_level2 VARCHAR(255)[] NOT NULL,
	moves_level6 VARCHAR(255)[] NOT NULL,
	moves_level10 VARCHAR(255)[] NOT NULL,
	moves_level14 VARCHAR(255)[] NOT NULL,
	moves_level18 VARCHAR(255)[] NOT NULL,
	moves_egg VARCHAR(255)[] NOT NULL,
	moves_tm INT[] NOT NULL
);
...
CREATE OR REPLACE FUNCTION verify_fakemon_write_key(
	_id UUID,
	_write_key VARCHAR(32)
) RETURNS INT AS $$
BEGIN
	RETURN (
		SELECT count(*) FROM private.fakemon
			WHERE id = _id AND write_key = _write_key
	);
END $$ LANGUAGE PLPGSQL STABLE SECURITY DEFINER;

CREATE OR REPLACE FUNCTION delete_fakemon(
	_write_key VARCHAR(32),
	_id UUID
) RETURNS INT
AS $$ 
