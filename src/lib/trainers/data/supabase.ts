...
export class SupabaseTrainerProvider implements TrainerDataProvider {
	...
	newTrainer = async (info: Pick<TrainerInfo, "name" | "description">): Promise<TrainerData & WithWriteKey> => {
		...
		const { data, error } = await this.supabase.rpc("new_trainer", {
			...
			_rank_athletics: toCreate.proficiencies["athletics"],
			_rank_acrobatics: toCreate.proficiencies["acrobatics"],
			_rank_sleight_of_hand: toCreate.proficiencies["sleight of hand"],
			_rank_stealth: toCreate.proficiencies["stealth"],
			_rank_arcana: toCreate.proficiencies["arcana"],
			_rank_history: toCreate.proficiencies["history"],
			_rank_investigation: toCreate.proficiencies["investigation"],
			_rank_nature: toCreate.proficiencies["nature"],
			_rank_religion: toCreate.proficiencies["religion"],
			_rank_animal_handling: toCreate.proficiencies["animal handling"],
			_rank_insight: toCreate.proficiencies["insight"],
			_rank_medicine: toCreate.proficiencies["medicine"],
			_rank_perception: toCreate.proficiencies["perception"],
			_rank_survival: toCreate.proficiencies["survival"],
			_rank_deception: toCreate.proficiencies["deception"],
			_rank_intimidation: toCreate.proficiencies["intimidation"],
			_rank_performance: toCreate.proficiencies["performance"],
			_rank_persuasion: toCreate.proficiencies["persuasion"],
	...
	updateTrainerInfo = async (writeKey: ReadWriteKey, info: TrainerInfo): Promise<boolean> => {
		const { data, error } = await this.supabase.rpc("update_trainer", {
			...
			_rank_athletics: info.proficiencies["athletics"],
			_rank_acrobatics: info.proficiencies["acrobatics"],
			_rank_sleight_of_hand: info.proficiencies["sleight of hand"],
			_rank_stealth: info.proficiencies["stealth"],
			_rank_arcana: info.proficiencies["arcana"],
			_rank_history: info.proficiencies["history"],
			_rank_investigation: info.proficiencies["investigation"],
			_rank_nature: info.proficiencies["nature"],
			_rank_religion: info.proficiencies["religion"],
			_rank_animal_handling: info.proficiencies["animal handling"],
			_rank_insight: info.proficiencies["insight"],
			_rank_medicine: info.proficiencies["medicine"],
			_rank_perception: info.proficiencies["perception"],
			_rank_survival: info.proficiencies["survival"],
			_rank_deception: info.proficiencies["deception"],
			_rank_intimidation: info.proficiencies["intimidation"],
			_rank_performance: info.proficiencies["performance"],
			_rank_persuasion: info.proficiencies["persuasion"],
	...
	addPokemonToTeam = async (writeKey: ReadWriteKey, trainerId: TrainerId, pokemon: Pokemon): Promise<TrainerPokemon> => {
		...
		const { data, error } = await this.supabase.rpc("add_pokemon", {
			...
			_rank_athletics: trainerPokemon.proficiencies["athletics"],
			_rank_acrobatics: trainerPokemon.proficiencies["acrobatics"],
			_rank_sleight_of_hand: trainerPokemon.proficiencies["sleight of hand"],
			_rank_stealth: trainerPokemon.proficiencies["stealth"],
			_rank_arcana: trainerPokemon.proficiencies["arcana"],
			_rank_history: trainerPokemon.proficiencies["history"],
			_rank_investigation: trainerPokemon.proficiencies["investigation"],
			_rank_nature: trainerPokemon.proficiencies["nature"],
			_rank_religion: trainerPokemon.proficiencies["religion"],
			_rank_animal_handling: trainerPokemon.proficiencies["animal handling"],
			_rank_insight: trainerPokemon.proficiencies["insight"],
			_rank_medicine: trainerPokemon.proficiencies["medicine"],
			_rank_perception: trainerPokemon.proficiencies["perception"],
			_rank_survival: trainerPokemon.proficiencies["survival"],
			_rank_deception: trainerPokemon.proficiencies["deception"],
			_rank_intimidation: trainerPokemon.proficiencies["intimidation"],
			_rank_performance: trainerPokemon.proficiencies["performance"],
			_rank_persuasion: trainerPokemon.proficiencies["persuasion"],
