...
export type DiceTiers = readonly [DiceRoll, DiceRoll, DiceRoll, DiceRoll]
...
export type DiceClass = keyof typeof DiceClasses

export const DiceClass = {
	getTier: (cl: DiceClass): DiceTiers => DiceClasses[cl],
}
