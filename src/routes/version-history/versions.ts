...
export const versionHistory: VersionHistory = {
	versions: [ {
		...
		description: [
			...
			"<strong>Encounters</strong>: Allow fakémon to be selected and generated in the encounter generator.",
			"<strong>Bugfix</strong>: Align Giga Drain's starting damage to other moves of its tier (2d6 → 1d12).",
			"<strong>Bugfix</strong>: Fix issue where hit dice was wrong for pokémon generated by the Encounter Tool.",
			"<strong>Bugfix</strong>: Fix issue where PP was sometimes always 5 for pokémon generated by the Encounter Tool.",
			"<strong>Bugfix</strong>: Stop showing deprecated eeveelutions on all lists in the site.",
		],
	}, {
		name: "v1.12.0",
		description: [
