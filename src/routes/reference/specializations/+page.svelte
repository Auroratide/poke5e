<script>
	import { SpecializationList, SpecializationList2018, specializationDescription } from "$lib/trainers/specializations"
	...
	$: list = $rulesVersion === "2018" ? SpecializationList2018 : SpecializationList
</script>
...
<ReferencePage title="Specializations">
	<section>
		...
		<h2>Options</h2>
		{#each Object.values(list) as specialization}
			<IconedCardHeading>
				{specialization.name}
				<div slot="icon" class="small-font"><TypeTag type={[specialization.type]} /></div>
			</IconedCardHeading>
