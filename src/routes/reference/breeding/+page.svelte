...
<ReferencePage title="Breeding">
	...
	<section>
		<Heading level="2" id="pokemon-eggs">Pokémon Eggs</Heading>
	...
	<section>
		<Heading level="2" id="creating-an-egg">Creating an Egg</Heading>
	...
	<section>
		<Heading level="2" id="incubation">Incubation</Heading>
		...
		<Heading level="3" id="incubators">Incubators</Heading>
	...
	<section>
		<Heading level="2" id="hatching">Hatching</Heading>
		...
		<Heading level="3" id="hatching-moves">Moves</Heading>
		...
		<Heading level="3" id="hatching-ability">Ability</Heading>
		...
		<Heading level="3" id="hatching-bond-level">Bond Level</Heading>
	...
	<section>
		<Heading level="2" id="special-caveats-rules">Special Caveats/Rules</Heading>
		<p>There are just a few circumstances that should be noted here when considering breeding.</p>
		<Heading level="3" id="ditto">Ditto</Heading>
		...
		<Heading level="3" id="undiscovered-group">Undiscovered Group</Heading>
		<p>Baby and Legendary Pokémon cannot breed. These are listed in the "Undiscovered" Egg Group for convenience.</p>
		<Heading level="3" id="gendered-species">Gendered Species</Heading>
	...
	<section>
		<Heading level="2" id="egg-groups">Egg Groups</Heading>
		{#if ($pokemon ?? []).length === 0}
			<Loader />
		{/if}
		{#each groupEntries as [groupName, group]}
			<div class="space-after">
				<div class="cap">
					<Heading level="3" id="egg-group-{groupName.toLocaleLowerCase().replaceAll(/\s/g, "-")}">{groupName}</Heading>
				</div>
