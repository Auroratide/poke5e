...
<ReferencePage title="Natures">
	<section>
		...
		{#if $currentEdition === "2018"}
			<Rules2018.NatureTable />
		{:else}
			<Rules2024.NatureTable />
		{/if}
	...
	<section>
		...
		<p>By default, custom natures do not modify attributes. You may work with your DM on what makes sense, or roll a {#if $currentEdition === "2018"}d20{:else}d100{/if} to apply one of the effects of the natures in the above table.</p>
	</section>
</ReferencePage>
