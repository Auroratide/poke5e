...
<ReferencePage title="Combat">
	...
	<section>
		<Heading level="2" id="moves-move-power">Moves/Move Power</Heading>
	...
	<section>
		<Heading level="2" id="flying-hovering-and-burrowing">Flying, Hovering, and Burrowing</Heading>
	...
	<section>
		<Heading level="2" id="raised-grounded">Raised/Grounded</Heading>
	...
	<section>
		<Heading level="2" id="reach">Reach</Heading>
