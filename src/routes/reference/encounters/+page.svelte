...
<ReferencePage title="Building Encounters">
	{#if $currentEdition === "2018"}
		...
		<section>
			<Heading level="2" id="wild-pokemon">Wild Pokémon</Heading>
		...
		<section>
			<Heading level="2" id="trainer-battles">Trainer Pokémon</Heading>
	...
	{:else}
		...
		<section>
			...
			<p>Experience for wild Pokémon encounters should be given out at the discretion of the DM, based on participation in the fight by each PC, or distributed equally among all players.</p>
			<Heading level="3" id="a-note-on-sr-vs-cr">A Note on SR vs CR</Heading>
			...
			<Heading level="3" id="a-note-on-biomes">A Note on Biomes</Heading>
		...
		<section>
			...
			<Heading level="3" id="awarding-money">Awarding Money</Heading>
		...
		<section>
			<Heading level="2" id="gym-battles">Gym Battles</Heading>
			...
			<Heading level="3" id="teamed-double-battles">Teamed Double Battles</Heading>
			...
			<Heading level="3" id="full-team-vs-full-team">Full Team vs Full Team</Heading>
			...
			<Heading level="3" id="parallel-1v1s">Parallel 1v1s</Heading>
