...
<Heading level="3" id="new-moves">New Moves</Heading>
...
<Heading level="3" id="stab-increase">STAB Increase</Heading>
<p><abbr>STAB</abbr> is an abbreviation for Same-Type Attack Bonus. Your Pokémon gains a bonus to damage rolls when it uses an attack move type that is the same as their Pokémon type. STAB may only be added once per move, even for moves that deal damage over time like Leech Seed, Smog, etc. This bonus increases as the Pokémon levels up.</p>

<Heading level="3" id="ability-score-improvement">Ability Score Improvement</Heading>
...
<p>This happens at levels 4, 8, 12, 16, and 20.</p>
